...
import com.arthurvlug.ageofrevolution.game.fieldmaterial.ResourceType;
...
//
        putVillager(0, 0, PlayerId.PLAYER_1, VillagerGender.MALE, Direction.NORTH_WEST, Activity.STANDARD, Status.STAND_GROUND, Optional.empty());
//
...
//
//        putVillager(0, 1, PlayerId.PLAYER_1, VillagerGender.MALE, Direction.SOUTH, Activity.BUILD_REPAIR, Status.ACT, Optional.empty());
...
//        putVillager(0, 2, PlayerId.PLAYER_1, VillagerGender.MALE, Direction.NORTH_WEST, Activity.BUILD_REPAIR, Status.STAND_GROUND, Optional.empty());
...
//        putVillager(10*size+6, PLAYER_1, MALE, NORTH, WOODCUTTER, WALK, Optional.of(CARRYING_WOOD));
    ...
    private void putVillager(final int x, final int y, final PlayerId playerId, final VillagerGender villagerGender, final Direction direction, final Activity activity, final Status status, final Optional<CarryingResource> carryingResource) {
    ...
    private MapElement villager(final int x, final int y, final PlayerId playerId, final VillagerGender villagerGender, final Direction direction, final Activity activity, final Status status, final Optional<CarryingResource> carryingResource) {
        final AbsoluteLocation coordinate = coordinate(x, y);
        return new MapElement(
                Optional.empty(),
